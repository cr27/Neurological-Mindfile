...
# NeurogenomeMindByte
 The genome mind byte is a cerebral cortex Neurogenome and 23&Me SNP Data. The cerebral cortex genome serves as a reference genome for the neurotranscriptome, neurometabolome and neuroproteome mind bytes. The SNP Data houses information about genetic traits related to a tested individual. The Database currently only hosts the reference genome.
